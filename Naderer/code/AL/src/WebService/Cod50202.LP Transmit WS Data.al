codeunit 50202 "LP Transmit WS Data"
{
    ...
    procedure SendRequests(endpoint: Text; var LoyaltyPointEntry: Record "LP Loyalty Point Entry"): Text
    var
        ...
        With LoyaltyPointEntry do
            if FindSet() then
                repeat
                    ...
                    WebServiceHelper.DoPostRequest(endpoint, RequestHeaders, ContentHeaders, Body, ResponseMessage);
